...
class SignUpPage:
    ...
    def __init__(self,main_frame):
        ...
        self.usr_phone_label = Label(self.right_frame, text='Phone Number')
        self.usr_phone_label.grid(row=1, column=0,sticky='w',padx=5,pady=5)

        self.usr_phone_field = Entry(self.right_frame)
        self.usr_phone_field.grid(row=1, column=1,sticky='w',padx=5,pady=5)

        self.usr_ID_label = Label(self.right_frame, text='National ID')
        self.usr_ID_label.grid(row=2, column=0,sticky='w',padx=5,pady=5)

        self.usr_ID_field = Entry(self.right_frame)
        ...
        self.usr_cnfpass_label = Label(self.right_frame, text='Confirm Password')
