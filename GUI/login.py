...
class LoginPage:
    def __init__(self,main_frame):
        ...
        self.img_lbl.grid(row=0,column=0,padx=5,pady=5)
        #Creting right frame
        ...
        self.usr_name_label.grid(row=0, column=0,padx=5,pady=5)

        self.usr_name_field = Entry(self.right_frame)
        self.usr_name_field.grid(row=0, column=1,padx=5,pady=5)

        self.usr_pass_label = Label(self.right_frame,text='Password')
        self.usr_pass_label.grid(row=1, column=0,padx=5,pady=5)

        self.usr_pass_field = Entry(self.right_frame,show="*")
        self.usr_pass_field.grid(row=1, column=1,padx=5,pady=5)
